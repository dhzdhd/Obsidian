...
class Database {
  ...
  Future<void> add(int userId, int guildId, String type, int value) async {
  ...
  Future<void> view(int userId, int guildId) async {
    await connection.open();
  ...
  Future<void> delete(int userId, int guildId) async {}
